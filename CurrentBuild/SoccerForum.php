...
if(isset($_POST['submitted'])){
	...
	//select	echo "$event_id + $time + $vi"
		...
		$sql = "update soccer set viewers = viewers + 1 where event_id = '$event_id'";
...
<head>
  ...
  <div class="container-fluid">
    ...
    <title>SoccerForum</title>
</head>
  
<body>  
<div id="background"><img src="images/soccer.jpg"></div>
    <center><h1>Soccer Events</h1></center>
    <div class="container">
...
while($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)){
	...
	echo '<form method = "post" action = "SoccerForum.php" >';
