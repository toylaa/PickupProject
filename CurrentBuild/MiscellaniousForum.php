...
if(isset($_POST['submitted'])){
	...
	//select	echo "$event_id + $time + $vi"
		...
		$sql = "update other set viewers = viewers + 1 where event_id = '$event_id'";
...
<head>
  ...
  <div class="container-fluid">
    ...
    <title>MiscellaneousForum</title>
</head>
  
<body background="images/tennisball.jpg">  
    <center><h1>Miscellaneous Events</h1></center>
    <div class="container">
...
while($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)){
	...
	echo '<form method = "post" action = "MiscellaniousForum.php" >';
	echo "<tr><td>";
	echo $row['user'];
	echo "</td><td>";
	echo $row['name'];
