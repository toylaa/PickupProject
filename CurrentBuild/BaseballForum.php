...
if(isset($_POST['submitted'])){
	...
	//select	echo "$event_id + $time + $vi"
		...
		$sql = "update baseball set viewers = viewers + 1 where event_id = '$event_id'";
...
<head>
  ...
  <div class="container-fluid">
    ...
    <title>BaseballForum</title>
</head>
 
<body>
	<div id="background"><img src="images/base.jpg"></div>
    <center><h1>Baseball Events</h1></center>
    <div class="container">
...
while($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)){
	...
	echo '<form method = "post" action = "BaseballForum.php" >';
	echo "<tr><td>";
	echo $row['user'];
	echo "</td><td>";
	echo $row['name'];
